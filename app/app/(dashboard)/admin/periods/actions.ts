...
const PLAN_FIELDS = (plan: ClientBillingPlan) => ({
  ...
  billing_percentage: plan.billing_percentage,
  base_fee:                   (plan as unknown as { base_fee?: number }).base_fee ?? 0,
  addon_subscription_amount: (plan as unknown as { addon_subscription_amount?: number | null }).addon_subscription_amount ?? null,
  addon_subscription_label:  (plan as unknown as { addon_subscription_label?: string | null }).addon_subscription_label ?? null,
