-- Migration 20260617000003 — generate_ads_billing v8
-- Fix line item text format: revenue shown before = sign, fee shown after.
-- Before: "12% ... Revenue 06-01 - 06-30 = $11542.61"  |  $1,385.11
-- After:  "12% ... Revenue 06-01 - 06-30 $11,542.61"   =  $1,385.11
-- The UI adds the "=" separator between text and amount.
...
-- DOWN: restore v7 (see 20260617000002)
