-- Migration 20260615000012 — generate_ads_billing v4
-- Fix: include batch from client_active_plans in the INSERT so billing grouping
-- matches clients.batch. Previously batch was always NULL for ADS rows.
